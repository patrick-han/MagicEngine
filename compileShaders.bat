...
dxc -spirv -I ./Shaders -T ps_6_0 -E main ./Shaders/triangleDebug.hlsl -Fo ./Shaders/triangleDebug.pixel.spv
dxc -spirv -I ./Shaders -T ps_6_0 -E main ./Shaders/trianglePixelVertexColorsOnly.hlsl -Fo ./Shaders/trianglePixelVertexColorsOnly.pixel.spv
